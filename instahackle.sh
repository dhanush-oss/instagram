C #!/bin/bash
# Inshackle v1.0
# recoded by: CYBER Dhanush
# github.com/dhanush-oss/instagram.git
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by cyber Dhanush (thanks to linuxchoice )\e[0m\n"
}
